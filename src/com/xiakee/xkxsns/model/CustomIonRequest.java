...
public abstract class CustomIonRequest {
	...
	public CustomIonRequest(Context c) {
		mContext = c;
	}
	...
	public void httpGet(String url) {
		...
		bar.setMessage("请稍后...");
		Ion.with(mContext).load(url).progressDialog(bar).asJsonObject().setCallback(new FutureCallback<JsonObject>() {
			@Override
