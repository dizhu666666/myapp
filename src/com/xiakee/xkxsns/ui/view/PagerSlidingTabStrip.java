...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorColor = Color.BLACK;//指示器的颜色
    ...
    private int indicatorHeight = 1;// 指示器的高度
    private int underlineHeight = 0;//下划线的高度
    ...
    private int tabTextSelectedColor = Color.BLACK;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        textMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, textMargin, dm);
    ...
    private void addTab(final int position, View tab) {
        ...
        LogUtils.e(position + "poss");
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT);
        if (position == 0) {
            params.rightMargin = textMargin;
        }
        tabsContainer.addView(tab, position, shouldExpand ? expandedTabLayoutParams : params);
    }
    ...
    private class PageListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            TextView tvSelected = (TextView) tabsContainer.getChildAt(position);
            tvSelected.setTextColor(tabTextSelectedColor);

            TextView tvLast = (TextView) tabsContainer.getChildAt(lastPosition);
            tvLast.setTextColor(tabTextColor);
