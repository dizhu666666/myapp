...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void stopLoadMore(boolean isEnd) {
        if (mPullLoading == true) {
            mPullLoading = false;
            if (isEnd) {
                mFooterView.setState(XListViewFooter.STATE_THEEND);
            } else {
                mFooterView.setState(XListViewFooter.STATE_NORMAL);
            }
        }
    ...
    public void stopLoadMore() {
        if (mPullLoading == true) {
            mPullLoading = false;
            mFooterView.setState(XListViewFooter.STATE_ERROR);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (pullEnable && getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
    ...
    public int getFooterVisibitlity() {
        return mFooterView.footerVisibility();
    }
}
