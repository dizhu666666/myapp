package com.android.photo.util;
...
public class Bimp {
	...
	public static Bitmap revitionImageSize(String path, Context context) throws IOException {
		final int reqWidth = DeviceInfo.scrrenWidth(context);
		final int reqHeight = DeviceInfo.scrrenHeight(context);
		return ImageUtil.compressedBitmap(path, reqWidth, reqHeight);
	}
